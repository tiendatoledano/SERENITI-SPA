// ============================================================
// supabase-service.js - SERVICIO DE SUPABASE (CORREGIDO)
...
// ============================================================
// FUNCIONES DE CONFIGURACIÓN GENERAL (CORREGIDAS CON UPSERT)
// ============================================================
...
// ============================================================
// CONFIGURACIÓN DE REGISTRO (CORREGIDO)
// ============================================================
...
// supabase-service.js - Función createTurno CORREGIDA
async function createTurno(turno) {
    try {
        // Asegurar que el objeto tenga todas las columnas necesarias
        const data = {
            id: turno.id || generarId(),
            nombre: turno.nombre,
            dia: turno.dia,
            fecha: turno.fecha,
            hora: turno.hora,
            ...
            codigo_cancelacion: turno.codigo_cancelacion || null,
            ip: turno.ip || 'N/A',
            conteo_bloqueos: turno.conteo_bloqueos || 0,
            bloqueado: turno.bloqueado || false
        };
...
async function createTokenUsuario(token, email) {
    try {
        ...
        console.error('Error creando token de usuario:', e);
        throw e;
    }
}
...
// supabase-service.js - upsertCodigoVerificacion CORREGIDO
async function upsertCodigoVerificacion(email, data) {
    try {
        ...
        if (columnError && columnError.code === 'PGRST204') {
            hasUpdatedAt = false;
            console.log('ℹ️ La columna updated_at no existe, omitiendo...');
        }
