...
// ============================================================
// WHATSAPP - RUTA CORREGIDA Y AGREGADA
// ============================================================
...
app.post('/api/enviar-whatsapp/:id', async (req, res) => {
    ...
    try {
        ...
        // Construir mensaje
        const mensaje = `🕯️ *SERENITY SPA* - Confirmación de Turno\n\n` +
            `👤 *Cliente:* ${turno.nombre}\n` +
            `📅 *Fecha:* ${turno.fecha || turno.dia}\n` +
            `⏰ *Hora:* ${turno.hora}:00 hs\n` +
            `💆‍♂️ *Servicio:* ${turno.massageType || 'Masaje'}\n` +
            `📍 *Ubicación:* ${turno.ubicacion || 'Salón Serenity Spa'}\n` +
            `📞 *Teléfono:* ${turno.codigoPais || ''} ${turno.telefono}\n\n` +
            `🔑 *Código de cancelación:* ${turno.codigoCancelacion || '---'}\n\n` +
            `*Gracias por elegir Serenity Spa.* 🌿\n` +
            `¡Te esperamos para brindarte la mejor experiencia de bienestar!`;
