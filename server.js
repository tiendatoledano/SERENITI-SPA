...
// ============================================================
const DATA_DIR = BASE_DIR; // ¡Usamos el directorio del proyecto!
...
async function initAllFiles() {
    ...
    if (!fsSync.existsSync(REGISTRO_FILE)) {
        ...
        try {
            ...
            console.log('📖 Contenido actual - Beneficio 2:', data.beneficios?.[1]?.descripcion);
        } catch(e) {
            console.error('Error leyendo registro-config.json:', e);
        }
    }
