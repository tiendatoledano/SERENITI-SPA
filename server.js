...
let palabrasBaneadas = [
    ...
    'zorra', 'zorro', 'prostituta', 'puta', 'perra', 'loca', 'loquita'
];
...
// ==================== VALIDACIÓN DE PALABRAS PROHIBIDAS (MEJORADA) ====================
...
function validarTelefonoCompleto(telefono) {
    ...
    // Verificar que no sean todos números repetidos
    ...
    if (/^12345678/.test(soloNumeros) || /^87654321/.test(soloNumeros) || /^01234567/.test(soloNumeros)) {
...
// ==================== TURNOS (CON VALIDACIONES MEJORADAS) ====================
...
app.post('/turnos', async (req, res) => {
    ...
    // 1. Validar nombre (con palabras prohibidas)
    ...
    // 3. Validar código de país
    let codPais = codigoPais || '53';
    if (!/^\d{1,3}$/.test(codPais)) codPais = '53';
    
    // 4. Validar dirección si es a domicilio
    ...
    // Verificar que no tenga otro turno el mismo día
    ...
    // Usar la ubicación del salón si es "salon"
...
// ==================== WHATSAPP CON IMAGEN Y DIRECCIÓN (MEJORADO) ====================
app.post('/api/enviar-whatsapp/:id', async (req, res) => {
    ...
    try {
        ...
        // ===== MENSAJE WHATSAPP MEJORADO CON DIRECCIÓN Y CÓDIGO =====
