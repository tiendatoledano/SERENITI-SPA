...
async function initAllFiles() {
    ...
    // REGISTRO-CONFIG.json (¡ESTE ES EL IMPORTANTE!)
...
app.post('/api/upload-hero', verifyAuth, async (req, res) => {
    try {
        ...
        const filepath = path.join('/tmp/data/uploads', filename);
...
// ============================================================
// ============================================================
// CONFIGURACIÓN REGISTRO - ¡ESTA ES LA PARTE CORREGIDA!
// ============================================================
...
app.get('/api/config/registro', async (req, res) => {
    ...
    try {
        ...
        console.log('📤 Enviando - Beneficio 1:', normalized.beneficios?.[0]?.descripcion);
        console.log('📤 Enviando - Beneficio 2:', normalized.beneficios?.[1]?.descripcion);
        res.json(normalized);
    } catch (e) {
...
app.put('/api/config/registro', verifyAuth, async (req, res) => {
    ...
    try {
        ...
        console.log('  - Beneficio 3:', data.beneficios?.[2]?.descripcion);
        ...
        console.log('📋 Datos normalizados - Beneficio 2:', normalizedData.beneficios?.[1]?.descripcion);
        ...
        console.log('✅ Verificación de guardado - Beneficio 2:', verifyData.beneficios?.[1]?.descripcion);
