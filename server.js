...
// server.js - Reemplazar la función esFechaValida y añadir función para obtener la próxima fecha disponible
...
function esFechaValida(dia) {
    ...
    // Si el día es hoy o un día futuro, es válido
...
function obtenerProximaFechaDisponible(diaSolicitado, turnosExistentes) {
    ...
    // Si el día solicitado no es válido o no está disponible, buscar el próximo
    ...
    if (diaBuscado && DIAS_VALIDOS.includes(diaBuscado)) {
        ...
        // Si el día ya pasó, buscar el siguiente disponible
...
app.post('/turnos', async (req, res) => {
    ...
    // VALIDACIÓN MEJORADA DE DÍA Y HORA
