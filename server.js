...
// ============================================================
// CONFIGURACIÓN DE BREVO (SENDINBLUE) - ENVÍO DE CORREOS
// ============================================================
...
// ============================================================
// CONFIGURACIÓN CORS (Para evitar errores de conexión)
// ============================================================
...
// ============================================================
// RUTAS DE REGISTRO Y VERIFICACIÓN DE USUARIOS (CON BREVO)
// ============================================================
...
app.post('/api/registro/solicitar-codigo', async (req, res) => {
    try {
        ...
        // Enviar correo con Brevo (sin restricciones de dominio)
        const mailOptions = {
            from: `"Serenity Spa" <${process.env.BREVO_USER}>`,
            to: email,
