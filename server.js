...
// ============================================================
// CONFIGURACIÓN REGISTRO - CORREGIDA
// ============================================================
...
app.get('/api/config/registro', async (req, res) => {
    try {
        ...
        if (fsSync.existsSync(REGISTRO_FILE)) {
            ...
            console.log('📖 Configuración de registro leída del archivo:', data.hero?.titulo);
        } else {
            ...
            console.log('📄 Archivo de registro no encontrado, usando valores por defecto');
        }
        ...
        if (data.beneficios && Array.isArray(data.beneficios)) {
            data.beneficios = data.beneficios.map(b => {
                ...
                if (b && typeof b === 'object') {
                    // Buscar cualquier propiedad que pueda contener el texto
        ...
        console.log('✅ Configuración de registro devuelta correctamente');
        res.json(data);
    } catch(e) {
...
app.put('/api/config/registro', async (req, res) => {
    ...
    try {
        ...
        console.log('📝 Guardando configuración de registro:', data);
        ...
        data.beneficios = data.beneficios.map(b => {
            ...
            if (!b || typeof b !== 'object') return { descripcion: '' };
            if (!b.descripcion) {
                // Buscar cualquier propiedad que pueda contener el texto
                const desc = b.texto || b.beneficio || b.desc || b.nombre || '';
                return { descripcion: desc };
            }
        ...
        data.conceptos = data.conceptos.map(c => {
            ...
            if (!c || typeof c !== 'object') return { titulo: 'Concepto', descripcion: '' };
            return {
                titulo: c.titulo || c.nombre || 'Concepto',
                descripcion: c.descripcion || c.desc || c.texto || ''
            };
        ...
        console.log('📋 Verificación de guardado - Hero:', verifyData.hero?.titulo);
        console.log('📋 Verificación de guardado - Beneficios:', verifyData.beneficios?.length);
