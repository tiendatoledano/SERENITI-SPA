...
// ============================================================
// TURNOS - CORREGIDO (SIN email_usuario)
// ============================================================
...
app.post('/turnos', async (req, res) => {
    try {
        ...
        const nuevoTurno = {
            ...
            confirmado: false,
            precio: precioFinal,
            usuario_id: usuarioId // Solo esta columna (opcional)
        };
        
        // Limpiar campos undefined para evitar errores en Supabase
        Object.keys(nuevoTurno).forEach(key => {
            if (nuevoTurno[key] === undefined) {
                delete nuevoTurno[key];
            }
        });
...
app.get('/api/turnos/mis-turnos', async (req, res) => {
    ...
    try {
        ...
        // Priorizar búsqueda por usuario_id (si existe)
        if (usuario.id) {
...
app.post('/api/turnos/confirmar/:id', async (req, res) => {
    ...
    try {
        ...
        // Verificar que el turno pertenece al usuario (por usuario_id)
        ...
        // Si no tiene usuario_id, verificar por nombre/telefono
        if (!turno.usuario_id) {
