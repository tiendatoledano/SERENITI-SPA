...
// ============================================================
// ⭐ CORREGIDO: LOGIN - SOLICITAR CÓDIGO (SIN ENVÍO DE EMAIL)
// El frontend se encarga de enviar el email con EmailJS
// ============================================================
app.post('/api/registro/login-solicitar-codigo', async (req, res) => {
    try {
        ...
        // ⭐ Devolver el código al frontend para que lo envíe con EmailJS
        console.log(`✅ Código de login generado para ${email}: ${codigo}`);
        res.json({ 
            success: true,
            codigo: codigo,  // ⭐ El frontend usará este código para enviar el email
            nombre: usuarioExistente.nombre
        });
