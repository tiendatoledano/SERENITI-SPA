...
// server.js - Función WhatsApp CORREGIDA (usa URL exacta)
    ...
    try {
        ...
        try {
            ...
            if (servicio && servicio.imagen_whatsapp) {
                // ✅ USAR LA URL EXACTAMENTE COMO ESTÁ EN LA BASE DE DATOS
                // SIN MODIFICARLA - SIN CONVERTIR, SIN AGREGAR EXTENSIÓN
...
*Equipo Serenity Spa*`;
        ...
        res.json({ 
            ...
            mensaje: mensaje,
            url: whatsappUrl,
            imagen: imagenWhatsApp  // ✅ Enviar la URL exacta
        });
