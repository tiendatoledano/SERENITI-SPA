...
// Configuración SMTP DEFINITIVA PARA RENDER (PUERTO 587 CON STARTTLS)
const transporter = nodemailer.createTransport({
    host: 'smtp.gmail.com',
    port: 587,
    secure: false, // OBLIGATORIO: false para el puerto 587
    auth: {
    ...
    tls: {
        ...
        ciphers: 'SSLv3' // Compatibilidad con Render
    },
