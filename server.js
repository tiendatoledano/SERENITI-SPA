...
async function isIPBloqueada(ip) {
    try {
        ...
        if (bloqueado) {
            console.log(`🛡️ IP BLOQUEADA DETECTADA: ${ip}`);
        }
        return bloqueado;
    } catch (error) {
...
// ============================================================
// ⭐ MIDDLEWARE DE BLOQUEO - PRIMERO EN EJECUTARSE (ANTES DE TODO)
// ============================================================
app.use(async (req, res, next) => {
    ...
    const excludedPaths = [
        '/bloqueado',           // Página de bloqueo (debe ser accesible)
        '/api/seguridad',       // API de seguridad (para admin)
        '/api/verify',          // Verificación de token
        '/api/login',           // Login
        '/api/config-emailjs'   // Configuración EmailJS
    ];
    
    // Si la ruta está en la lista de excluidas, continuar
    ...
    if (bloqueado) {
        ...
        // ⭐ PARA CUALQUIER OTRA SOLICITUD: REDIRIGIR A /bloqueado
...
// ============================================================
// ⭐ RUTA DE BLOQUEO - PÁGINA QUE SE MUESTRA AL USUARIO BLOQUEADO
// ============================================================
app.get('/bloqueado', (req, res) => {
    // Configurar headers para que NO se cachee esta página
...
// ============================================================
// RUTAS HTML - TODAS PASAN POR EL MIDDLEWARE DE BLOQUEO
// ============================================================
app.get('/', (req, res) => {
