...
app.post('/turnos', async (req, res) => {
    try {
        ...
        // ⭐ TODOS LOS DÍAS POR DEFECTO (incluye domingo)
        const diasLaborales = horariosConfig.dias && horariosConfig.dias.length > 0 
            ? horariosConfig.dias.map(d => d.toLowerCase()) 
...
app.get('/api/debug/horarios', verifyAuth, async (req, res) => {
    try {
        ...
        res.json({
            ...
            fin: horarios.fin,
            totalDias: horarios.dias.length,
