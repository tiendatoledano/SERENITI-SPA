...
// ============================================================
// MIDDLEWARE DE BLOQUEO DE IP - SE EJECUTA DESPUÉS DE RUTAS ESTÁTICAS
// ============================================================
...
// ============================================================
// WHATSAPP - CORREGIDO PARA MOSTRAR IMAGEN
// ============================================================
...
// ============================================================
// PAÍSES - CORREGIDO PARA GUARDAR UBICACIÓN
// ============================================================
...
// ============================================================
// BLOQUEO/DESBLOQUEO DE IPs POR TURNO
// ============================================================
...
app.post('/api/seguridad/bloquear-usuario-ip/:id', verifyAuth, async (req, res) => {
    try {
        ...
        // Bloquear la IP en el sistema de seguridad
        ...
        res.json({ 
            ...
            ip: ipUsuario,
            conteo: nuevoConteo,
            mensaje: `IP ${ipUsuario} bloqueada exitosamente`
        });
    ...
    try {
        ...
        if (resultado) {
            res.json({ 
                success: true, 
                ip: ip,
                mensaje: `IP ${ip} desbloqueada exitosamente`
            });
        } else {
...
app.post('/api/seguridad/bloquear-ip', verifyAuth, async (req, res) => {
    try {
        ...
        res.json({ 
            success: true, 
            ip: ip,
            mensaje: `IP ${ip} bloqueada exitosamente`
        });
