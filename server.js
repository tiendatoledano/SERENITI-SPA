...
async function initAllFiles() {
    ...
    // OTROS ARCHIVOS
    // ============================================================
    const archivos = [CONFIG_FILE, PAISES_FILE, HORARIOS_FILE, PALABRAS_BANEADAS_FILE, REGISTRO_CONFIG_FILE, TOKEN_EMAIL_FILE, CODIGOS_FILE];
