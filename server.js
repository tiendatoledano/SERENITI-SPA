...
// ============================================================
// VERIFICACIÓN DE CÓDIGO (NUEVA RUTA)
// ============================================================
app.post('/api/registro/verificar-codigo', async (req, res) => {
    try {
        ...
        res.json({
            ...
            token: token,
            usuario: {
                id: nuevoUsuario.id || existe?.id,
                nombre: nuevoUsuario.nombre || existe?.nombre,
                email: nuevoUsuario.email || existe?.email
            }
        });
