...
// ============================================================
// CONFIGURACIÓN REGISTRO - CORREGIDO CON VALIDACIÓN DE ESTRUCTURA
// ============================================================
    ...
    try {
        ...
        if (data.beneficios.length < 6) {
            ...
            while (data.beneficios.length < 6) {
                data.beneficios.push(defaultBeneficios[data.beneficios.length]);
            }
        }
        // Asegurar que cada beneficio tenga la propiedad descripcion
...
app.put('/api/config/registro', async (req, res) => {
    ...
    try {
        ...
        console.log('✅ Configuración de registro guardada correctamente con imagen:', data.imagenWhatsApp);
