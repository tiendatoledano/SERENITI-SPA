...
// Configuración SMTP DEFINITIVA - CONEXIÓN ESTABLE
const transporter = nodemailer.createTransport({
    ...
    // Timeouts más largos para evitar "Connection timeout"
    connectionTimeout: 30000, // 30 segundos (antes 10)
    greetingTimeout: 30000,   // 30 segundos (antes 10)
    socketTimeout: 60000,     // 60 segundos (antes 15)
    debug: true,
    logger: true,
    // Nueva línea: Forzar el uso de TLS 1.2 o superior (obligatorio para Gmail)
    tls: {
        rejectUnauthorized: false // Permite conexiones incluso si el certificado no es perfecto
    }
});
