...
// ============================================================
// USAR EL DIRECTORIO DEL PROYECTO (PERSISTENTE)
// ============================================================
...
async function initAllFiles() {
    ...
    if (!fsSync.existsSync(REGISTRO_FILE)) {
        ...
        console.log('✅ registro-config.json creado en:', REGISTRO_FILE);
    } else {
        console.log('✅ registro-config.json ya existe en:', REGISTRO_FILE);
    }
...
function normalizeRegistroConfig(data) {
    ...
    if (!data.hero.titulo) data.hero.titulo = 'El Arte del Masaje Profesional';
    if (!data.hero.subtitulo) data.hero.subtitulo = 'Domina las técnicas que transforman cuerpos y vidas';
    if (!data.hero.boton) data.hero.boton = 'Comenzar Ahora';
