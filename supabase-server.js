// ============================================================
// supabase-service.js - SERVICIO DE SUPABASE (VERSIÓN FINAL CORREGIDA)
// ============================================================
...
// ============================================================
// ⭐ HORARIOS - CORREGIDO (TODOS LOS DÍAS POR DEFECTO)
// ============================================================
...
async function getHorarios() {
    try {
        ...
        // ⭐ TODOS LOS DÍAS por defecto en caso de error
        return {
            dias: ['lunes', 'martes', 'miercoles', 'jueves', 'viernes', 'sabado', 'domingo'],
...
async function setHorarios(data) {
    // ⭐ Asegurar que los días estén en minúsculas
    const datosLimpios = {
...
// ============================================================
// ⭐ TURNOS - CORREGIDO (sintaxis correcta para not.in)
// ============================================================

async function getTurnos() {
    try {
        // ⭐ CORREGIDO: sintaxis correcta para not.in en Supabase
        const { data, error } = await supabase
            .from('turnos')
            .select('*')
